...
function computeFrame(time) {
    ...
    const cylinder = sceneElements.sceneGraph.getObjectByName("cilindro");
    const cube = sceneElements.sceneGraph.getObjectByName("cubo");
    const sphere = sceneElements.sceneGraph.getObjectByName("esfera");
